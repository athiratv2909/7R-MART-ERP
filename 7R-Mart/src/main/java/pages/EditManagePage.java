...
public class EditManagePage {

		
		WebDriver driver;

		public EditManagePage(WebDriver driver)	
		{
		this.driver=driver;
		...
		@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/pages/edit?edit=1409&page_ad=1' and @class='btn btn-sm btn btn-primary btncss']")private WebElement clickeditbtn;
